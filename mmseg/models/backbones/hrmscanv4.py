...
class HRMscanv4(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(HRMscanv4, self).__init__(init_cfg)
        ...
        for i in range(self.num_stages):
            fusion_mscan_block = SpatialAttention(dim=embed_dims[i])
    ...
    def forward(self, x):
        ...
        for i in range(len(y_list)):
            ...
            for j in range(self.block_nums[i]):
                x = x + fusion_mscan_block(x)
                x = batch_norm(x)
            outs.append(x)
    ...
    def train(self, mode=True):
        ...
        layer freezed."""
        super(HRMscanv4, self).train(mode)
        self._freeze_stages()
