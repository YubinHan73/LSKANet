...
data_root = '/data2/hyb/DataSurgery/endovis'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root='/data2/hyb/DataSurgery/endovis2018',
    ...
    test=dict(
        ...
        # img_dir='leftImg8bit/test_motionblur',
        # img_dir='leftImg8bit/test_jiawu',
        # img_dir='leftImg8bit/test_motionblur_jiawu',
        ann_dir='gtFine/test',
        pipeline=test_pipeline))
log_config = dict(
