...
dataset_type = 'TMEDataset'
data_root = '/data2/hyb/DataSurgery/Lapavis_train2250_test750'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(2048, 1240), ratio_range=(0.5, 2.0)),
...
work_dir = './work_dirs/0_LSKANet/LSKANet_TME'
gpu_ids = [0]
auto_resume = False
